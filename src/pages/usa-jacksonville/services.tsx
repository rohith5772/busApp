...
<li><Link href="/usa-jacksonville/clay_county">Clay Country Flex</Link></li>
<li><Link href="/usa-jacksonville/express_select">Express Select</Link></li>
<li><Link href="/usa-jacksonville/jta">JTA</Link></li>
<li><Link href="/usa-jacksonville/sunshine_bus">Sunshine Bus Company</Link></li>
...
<ul className = "no-bullets">
<li><Link href="/usa-jacksonville/transportation_authority">TRANSPORTATION_AUTHORITY</Link></li>
</ul>
</div>
</div >
  <footer>
