...
<ul className = "no-bullets">
  <li><Link href="/india/hyderabad/bus-service/hyderabad_local_bus">Telangana State Road Transport Corporation (hyderabad local bus)</Link></li>
  <li><Link href="/india/hyderabad/bus-service/hyderabad_local_electric_bus">TSRTC Pushpak (Airport Electric Buses)</Link></li>
  <li><Link href="/india/hyderabad/bus-service/hyderabad_local_long_distance_bus">TSRTC hyderabad Long Distance Buses</Link></li>
  <li><Link href="/india/hyderabad/bus-service/hyderabad_metro_feeder_bus">SVIDA (Metro Feeder Bus Services)</Link></li>
  <li><Link href="/india/hyderabad/bus-service/hyderabad_local_ac_bus">TSRTC Vajra AC Bus Service</Link></li>
</ul>
<h1>Train agencies</h1>
<ul className = "no-bullets">
  <li><Link href="/india/hyderabad/train-service/hyderabad_local_train">Hyderabad Multi-Modal Transport System</Link></li>
</ul>
<h1>Metro Services</h1>
<ul className = "no-bullets">
  <li><Link href="/india/hyderabad/train-service/metro">Metro</Link></li>
</ul>
</div>
</div >
  <footer>
