...
export default function App(props: any) {
  ...
  const metaDescription = "Chennai City Bus Routes TimeTable from"+props.from+"to"+ props.to;
  const titleVal = "Chennai City Bus Routes TimeTable of route " +props.busId+ " from " +props.fromVal+ " to " +props.toVal;
...
<td className = "td-class">{myArray.map((timings : any , i : number)=>{
  ...
  return (
    <div>
    <title>{titleVal}</title><meta name = "keyword" content="find bus schedule,City bus timetable, Chennai City Bus,,bus schedule,"/>
    <meta name="description" content={metaDescription} />
    <meta name="keyword" content="Chennai City Bus Routes, Chennai bus timings" />

    <h1 className="h1class"><a href="" title="Chennai Bus Routes " target="_self">Chennai City Bus Routes</a></h1>
    <div className="topnav" id="myTopnav">
    <Link id = "home" href="/india/Chennai">home</Link>
        <Link id = "bustimings"  href="/india/Chennai/bustimings">Search Bus</Link>
        <Link id = "allbuses"  href="/india/Chennai/allbuses" className="active">All Buses</Link>
        <Link id = "contact"  href="/india/Chennai/contact">Contact</Link>
        <Link id = "about"  href="/india/Chennai/about">About</Link>
        <Link id = "metrotimings" href="/india/Chennai/metrotimings">Metro Timings</Link>
...
const filePath = path.join(process.cwd(), 'src/json/india/chennai/'+filename+'.json');
