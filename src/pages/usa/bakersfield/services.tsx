...
<ul className = "no-bullets">
  <li><Link href="/usa/bakersfield/bus-service/get_bus">GET Bus</Link></li>
  <li><Link href="/usa/bakersfield/bus-service/kern_transit">Kern Transit</Link></li>
  <li><Link href="/usa/bakersfield/bus-service/dart">DART</Link></li>
  <li><Link href="/usa/bakersfield/bus-service/arvin-transit">Arvin Transit</Link></li>
  <li><Link href="/usa/bakersfield/bus-service/ridgerunner">Ridgerunner</Link></li>
  <li><Link href="/usa/bakersfield/bus-service/taft_area">TAFT Area Transit</Link></li>
  <li><Link href="/usa/bakersfield/bus-service/alvand_transportation">Alvand Transportation</Link></li>
  <li><Link href="/usa/bakersfield/bus-service/amtrak_chartered">Amtrak Chartered Vehicle</Link></li>
...
<ul className = "no-bullets">
  <li><Link href="/usa/bakersfield/train-service/amtrak">Amtrak</Link></li>
