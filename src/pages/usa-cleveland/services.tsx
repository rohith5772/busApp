...
<li><Link href="/usa-cleveland/laketran">LAKETRAN</Link></li>
<li><Link href="/usa-cleveland/mcpt">MCPT</Link></li>
<li><Link href="/usa-cleveland/parta">PARTA</Link></li>
<li><Link href="/usa-cleveland/rta1">RTA1</Link></li>
<li><Link href="/usa-cleveland/rta2">RTA2</Link></li>
<li><Link href="/usa-cleveland/sarta">SARTA</Link></li>
</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-cleveland/amtrak">AMTRAK</Link></li>
<li><Link href="/usa-cleveland/cvsr">CVSR</Link></li>
</ul>
<h1>Subway Agencies</h1>
<ul className = "no-bullets">
<li><Link href="/usa-cleveland/rta_red_line">RTA_RED_LINE</Link></li>
</ul>
<h1>Light Rail Agencies</h1>
<ul className = "no-bullets">
<li><Link href="/usa-cleveland/rta_rail">RTA_RAIL</Link></li>
