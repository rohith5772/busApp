...
export default function App(props: any) {
  ...
  const metaDescription = "Bengaluru City Bus Routes TimeTable from"+props.from+"to"+ props.to;
  const titleVal = "Bengaluru City Bus Routes TimeTable of route " +props.busId+ " from " +props.fromVal+ " to " +props.toVal;
...
<td className = "td-class">{myArray.map((timings : any , i : number)=>{
  ...
  return (
    <div>
    <title>{titleVal}</title><meta name = "keyword" content="find bus schedule,City bus timetable, Bengaluru City Bus,,bus schedule,"/>
    <meta name="description" content={metaDescription} />
    <meta name="keyword" content="Bengaluru City Bus Routes, Bengaluru bus timings" />

    <h1 className="h1class"><a href="" title="Bengaluru Bus Routes " target="_self">Bengaluru City Bus Routes</a></h1>
    <div className="topnav" id="myTopnav">
    <Link id = "home" href="/india/Bengaluru">home</Link>
        <Link id = "bustimings"  href="/india/Bengaluru/bustimings">Search Bus</Link>
        <Link id = "allbuses"  href="/india/Bengaluru/allbuses" className="active">All Buses</Link>
        <Link id = "contact"  href="/india/Bengaluru/contact">Contact</Link>
        <Link id = "about"  href="/india/Bengaluru/about">About</Link>
        <Link id = "metrotimings" href="/india/Bengaluru/metrotimings">Metro Timings</Link>
...
const filePath = path.join(process.cwd(), 'src/json/india/bengaluru/'+filename+'.json');
