...
<ul className = "no-bullets">
  <li><Link href="/india/bengaluru/bus-service/bmtc_1">Bengaluru Local Buses 1</Link></li>
  <li><Link href="/india/bengaluru/bus-service/bmtc_2">Bengaluru Local Buses 2</Link></li>
  <li><Link href="/india/bengaluru/bus-service/bmtc_3">Bengaluru Local Buses 3</Link></li>
  <li><Link href="/india/bengaluru/bus-service/bmtc_airport_bus">Bengaluru Airport Buses</Link></li>
</ul>
<h1>SWR Trains</h1>
<ul className = "no-bullets">
  <li><Link href="/india/bengaluru/train-service/swr_trains">SWR Trains</Link></li>
</ul>
<h1>Metro Services</h1>
<ul className = "no-bullets">
  <li><Link href="/india/bengaluru/train-service/metro">Namma Metro
</Link></li>
</ul>
</div>
</div >
