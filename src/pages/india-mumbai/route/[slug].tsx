...
export default function App(props: any) {
  ...
  const metaDescription = "Mumbai City Bus Routes TimeTable from"+props.from+"to"+ props.to;
  const titleVal = "Mumbai City Bus Routes TimeTable of route " +props.busId+ " from " +props.fromVal+ " to " +props.toVal;
...
<td className = "td-class">{myArray.map((timings : any , i : number)=>{
  ...
  return (
    <div>
    <title>{titleVal}</title><meta name = "keyword" content="find bus schedule,City bus timetable, Mumbai City Bus,,bus schedule,"/>
    <meta name="description" content={metaDescription} />
    <meta name="keyword" content="Mumbai City Bus Routes, Mumbai bus timings" />

    <h1 className="h1class"><a href="" title="Mumbai Bus Routes " target="_self">Mumbai City Bus Routes</a></h1>
    <div className="topnav" id="myTopnav">
    <Link id = "home" href="/india/Mumbai">home</Link>
        <Link id = "bustimings"  href="/india/Mumbai/bustimings">Search Bus</Link>
        <Link id = "allbuses"  href="/india/Mumbai/allbuses" className="active">All Buses</Link>
        <Link id = "contact"  href="/india/Mumbai/contact">Contact</Link>
        <Link id = "about"  href="/india/Mumbai/about">About</Link>
        <Link id = "metrotimings" href="/india/Mumbai/metrotimings">Metro Timings</Link>
...
const filePath = path.join(process.cwd(), 'src/json/india/mumbai/'+filename+'.json');
