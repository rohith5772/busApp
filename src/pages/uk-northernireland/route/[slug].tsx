...
export default function App(props: any) {
  ...
  const metaDescription = "Pune City Bus Routes TimeTable from"+props.from+"to"+ props.to;
  const titleVal = "Pune City Bus Routes TimeTable of route " +props.busId+ " from " +props.fromVal+ " to " +props.toVal;
...
<td className = "td-class">{myArray.map((timings : any , i : number)=>{
  ...
  return (
    <div>
    <title>{titleVal}</title><meta name = "keyword" content="find bus schedule,City bus timetable, Pune City Bus,,bus schedule,"/>
    <meta name="description" content={metaDescription} />
    <meta name="keyword" content="Pune City Bus Routes, Pune bus timings" />

    <h1 className="h1class"><a href="" title="Pune Bus Routes " target="_self">Pune City Bus Routes</a></h1>
    <div className="topnav" id="myTopnav">
    <Link id = "home" href="/india/Pune">home</Link>
        <Link id = "bustimings"  href="/india/Pune/bustimings">Search Bus</Link>
        <Link id = "allbuses"  href="/india/Pune/allbuses" className="active">All Buses</Link>
        <Link id = "contact"  href="/india/Pune/contact">Contact</Link>
        <Link id = "about"  href="/india/Pune/about">About</Link>
        <Link id = "metrotimings" href="/india/Pune/metrotimings">Metro Timings</Link>
...
const filePath = path.join(process.cwd(), 'src/json/uk/northernireland/'+filename+'.json');
