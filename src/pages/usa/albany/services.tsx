...
<ul className = "no-bullets">
  <li><Link href="/usa/albany/bus-service/cdta">CDTA</Link></li>
  <li><Link href="/usa/albany/bus-service/greene_county">Greene County Transit</Link></li>
  <li><Link href="/usa/albany/bus-service/gloversville">Gloversville Transit Services</Link></li>
  <li><Link href="/usa/albany/bus-service/vermont">Vermont Translines</Link></li>
  <li><Link href="/usa/albany/bus-service/amtrak_chartered">Amtrak Chartered Vehicle</Link></li>
  <li><Link href="/usa/albany/bus-service/downtown">Downtown</Link></li>
  <li><Link href="/usa/albany/bus-service/yankee">Yankee Trails</Link></li>
  <li><Link href="/usa/albany/bus-service/greater_falls">Greater Glens Falls Transit</Link></li>
