...
<li><Link href="/usa-stockton/amtrak_chartered">Amtrak_Chartered</Link></li>
<li><Link href="/usa-stockton/rtd">RTD</Link></li>
</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-stockton/altamont_corridor">Altamont_Corridor</Link></li>
<li><Link href="/usa-stockton/amtrak">AMTRAK</Link></li>
</ul>
