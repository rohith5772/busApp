...
<li><Link href="/usa-tampast/amtrak_chartered">Amtrak_Chartered</Link></li>
<li><Link href="/usa-tampast/gopasco">Gopasco</Link></li>
<li><Link href="/usa-tampast/hart">HART</Link></li>
<li><Link href="/usa-tampast/psta">PSTA</Link></li>
</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-tampast/amtrak">Amtrak</Link></li>

</ul>

<h1>Light Rail Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-tampast/teco_line">TECO_Line</Link></li>
</ul>
