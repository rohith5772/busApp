...
<div className="row">
<h1>Bus Services</h1>
<li><Link href="/usa-dallas/dart_bus">DART_BUS</Link></li>
<li><Link href="/usa-dallas/dcta">DCTA</Link></li>
<li><Link href="/usa-dallas/dfw_terminal_link">DFW_TERMINAL_LINK</Link></li>
<li><Link href="/usa-dallas/grapevine_visitors_shuttle">GRAPEVINE_VISITORS_SHUTTLE</Link></li>
<li><Link href="/usa-dallas/star_transit">STAR_TRANSIT</Link></li>
<li><Link href="/usa-dallas/trinity_metro">TRINITY_METRO</Link></li>
</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-dallas/amtrak">AMTRAK</Link></li>
<li><Link href="/usa-dallas/a_train">A_TRAIN</Link></li>
<li><Link href="/usa-dallas/tre">TRE</Link></li>
</ul>
<h1>Light Rail Agencies</h1>
<ul className = "no-bullets">
  <li><Link href="/usa-dallas/trinity_metro">TRINITY_METRO</Link></li>
  <li><Link href="/usa-dallas/dart_train">DART_TRAIN</Link></li>
</ul>
<h1>Cable Car agencies</h1>
<ul className = "no-bullets">
<li><Link href="/usa-dallas/dart_streetcar">DART_STREETCAR</Link></li>
</ul>
</div>
</div >
  <footer>
