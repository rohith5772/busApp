...
<li><Link href="/usa-flint/indian_trails">Indian Trails</Link></li>
<li><Link href="/usa-flint/mta_flint">MTA Flint</Link></li>

</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-flint/amtrak">Amtrak</Link></li>
</ul>
</div>
</div >
  <footer>
