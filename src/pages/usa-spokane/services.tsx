...
<li><Link href="/usa-spokane/gold_line">Gold_Line</Link></li>
<li><Link href="/usa-spokane/northwestern_trailways">Northwestern_Trailways</Link></li>
<li><Link href="/usa-spokane/spokane_transit">Spokane_Transit</Link></li>
</ul>

<ul className = "no-bullets">
<li><Link href="/usa-spokane/amtrak">Amtrak</Link></li>
