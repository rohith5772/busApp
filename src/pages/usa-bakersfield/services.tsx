...
<li><Link href="/usa-bakersfield/alvand_transportation">Alvand Transpoertation</Link></li>
<li><Link href="/usa-bakersfield/amtrak_chartered">Amtrak Chatered Vehicle</Link></li>
<li><Link href="/usa-bakersfield/arvin_transit">Arvin Transit</Link></li>
<li><Link href="/usa-bakersfield/dart">DART</Link></li>
<li><Link href="/usa-bakersfield/get_bus">GET Bus</Link></li>
<li><Link href="/usa-bakersfield/kern_transit">Kern Transit</Link></li>
<li><Link href="/usa-bakersfield/ridgerunner">Ridgerunner</Link></li>
<li><Link href="/usa-bakersfield/taft_area">TAFT Area Transit</Link></li>
<li><Link href="/usa-bakersfield/amtrak">Amtrak</Link></li>
</ul>
