...
<li><Link href="/usa-raleigh/chapel_hill">CHAPEL_HILL</Link></li>
<li><Link href="/usa-raleigh/duke_transit">DUKE_TRANSIT</Link></li>
<li><Link href="/usa-raleigh/go_cary">GO_CARY</Link></li>
<li><Link href="/usa-raleigh/go_durham">GO_DURHAM</Link></li>
<li><Link href="/usa-raleigh/go_raleigh">GO_RALEIGH</Link></li>
<li><Link href="/usa-raleigh/go_triangle">GO_TRIANGLE</Link></li>
<li><Link href="/usa-raleigh/ocpt">OCPT</Link></li>
<li><Link href="/usa-raleigh/wolfline">WOLFLINE</Link></li>

</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-raleigh/amtrak">AMTRAK</Link></li>
</ul>
</div>
</div >
  <footer>
