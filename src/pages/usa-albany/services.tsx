...
<ul className = "no-bullets">
  <li><Link href="/usa-albany/amtrak_chartered">Amtrak Chartered Vehicle</Link></li>
  <li><Link href="/usa-albany/cdta">CDTA</Link></li>
  <li><Link href="/usa-albany/downtown">DOWNTOWN</Link></li>
  <li><Link href="/usa-albany/gloversville">Gloversville Transit Services</Link></li>
  <li><Link href="/usa-albany/greater_falls">Greater Glens Falls Transit (518-792-1085)</Link></li>
  <li><Link href="/usa-albany/greene_county">Greene County Transit</Link></li>
  <li><Link href="/usa-albany/vermont">Vermont Translines</Link></li>
  <li><Link href="/usa-albany/yankee">Rensselaer County/Yankee Trails</Link></li>
  <li><Link href="/usa-albany/adirondack_trailways">Adirondack Trailways</Link></li>
