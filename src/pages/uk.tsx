        ...
        <div className="region">
          ...
          <div className="cities">
            <article className="city" data-region-id="uk-london" data-region-live="true">
              <Link href="/uk-eastanglia/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-london-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>East Anglia</b></h1>
                </div></Link>
            </article>
            <article className="city" data-region-id="uk-newcastle" data-region-live="true">
              <Link href="/uk-cumbria/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-mexico-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>North East and Cumbria</b></h1>
                </div></Link>
            </article>

            <article className="city" data-region-id="uk-manchester" data-region-live="true">
              <Link href="/uk-scotland/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-manchester-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>Scotland</b></h1>
                </div></Link>
            </article>
            <article className="city" data-region-id="uk-manchester" data-region-live="true">
              <Link href="/uk-westmidlands/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-liverpool-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>West Midlands</b></h1>
                </div></Link>
            </article>
            <article className="city" data-region-id="uk-birmingham" data-region-live="true">
              <Link href="/uk-eastmidlands/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-birmingham-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>East Midlands</b></h1>
                </div></Link>
            </article>
            <article className="city" data-region-id="uk-edinburgh" data-region-live="true">
              <Link href="/uk-northwest/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-edinburgh-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>North West</b></h1>
                </div></Link>
            </article>
            <article className="city" data-region-id="uk-edinburgh" data-region-live="true">
              <Link href="/uk-southwest/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-glasgow-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>South West</b></h1>
                </div></Link>
            </article>
            <article className="city" data-region-id="uk-birmingham" data-region-live="true">
              <Link href="/uk-yorkshire/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-nottingham-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>Yorkshire</b></h1>
                </div></Link>
            </article>
            <article className="city" data-region-id="uk-bristol" data-region-live="true">
              <Link href="/uk-london/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-cardiff-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>London</b></h1>
                </div></Link>
            </article>
            <article className="city" data-region-id="uk-bristol" data-region-live="true">
              <Link href="/uk-northernireland/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-cardiff-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>Northern Ireland</b></h1>
                </div></Link>
            </article>
            <article className="city" data-region-id="uk-bristol" data-region-live="true">
              <Link href="/uk-wales/services"><Image className="city-image" src="https://global-api.citymapper.com/resourceproxy/greenie-cardiff-web.png" width="141" height="141" alt=" "/>
                <div className="city-copy">
                  <h1 className="city-name"><b>Wales</b></h1>
                </div></Link>
            </article>
          </div>
        </div>
