...
<li><Link href="/usa-greensboro/davidson_county">Davidson Country</Link></li>
<li><Link href="/usa-greensboro/gta">GTA</Link></li>
<li><Link href="/usa-greensboro/high_point_transit">High Point Transit</Link></li>
<li><Link href="/usa-greensboro/link_transit">LINK TRANSIT</Link></li>
<li><Link href="/usa-greensboro/part">PART</Link></li>

</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-greensboro/amtrak">Amtrak</Link></li>
</ul>
</div>
</div >
  <footer>
