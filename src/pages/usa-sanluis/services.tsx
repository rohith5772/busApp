...
<li><Link href="/usa-sanluis/americanstar">Americanstar</Link></li>
<li><Link href="/usa-sanluis/amtrak_chartered_motorcoach">Amtrak_Chartered_Motorcoach</Link></li>
<li><Link href="/usa-sanluis/guadalupe_flyer">Guadalupe_Flyer</Link></li>
<li><Link href="/usa-sanluis/slo">SLO</Link></li>
<li><Link href="/usa-sanluis/smrt">SMRT</Link></li>
<li><Link href="/usa-sanluis/soco_transit">Soco_Transit</Link></li>
</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-sanluis/amtrak">Amtrak</Link></li>
</ul>
</div>
</div >
  <footer>
