...
<li><Link href="/usa-eugene/diamond_express">DIAMOND_EXPRESS</Link></li>
<li><Link href="/usa-eugene/link_lane">LINK_LANE</Link></li>
<li><Link href="/usa-eugene/pacific_crest">PACIFIC_CREST</Link></li>
<li><Link href="/usa-eugene/rhody_exp">RHODY_EXP</Link></li>
</ul>
<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-eugene/amtrak">AMTRAK</Link></li>
</ul>
</div>
</div >
  <footer>
