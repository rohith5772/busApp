...
<li><Link href="/usa-detroit/amtrak_chartered">AMTRAK_CHARTERED</Link></li>
<li><Link href="/usa-detroit/d2a2">D2A2</Link></li>
<li><Link href="/usa-detroit/ddot">DDOT</Link></li>
<li><Link href="/usa-detroit/michigan_flyer">MICHIGAN_FLYER</Link></li>
<li><Link href="/usa-detroit/smart">SMART</Link></li>
<li><Link href="/usa-detroit/the_ride">THE_RIDE</Link></li>
<li><Link href="/usa-detroit/um_transit">UM_TRANSIT</Link></li>
</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-detroit/amtrak">AMTRAK</Link></li>
</ul>
<h1>Light Rail Agencies</h1>
<ul className = "no-bullets">
<li><Link href="/usa-detroit/people_mover">PEOPLE_MOVER</Link></li>
<li><Link href="/usa-detroit/qline">QLINE</Link></li>
</ul>
</div>
</div >
  <footer>
