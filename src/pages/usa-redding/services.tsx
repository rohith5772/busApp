...
<li><Link href="/usa-redding/amtrak_chartered">AMTRAK_CHARTERED</Link></li>
<li><Link href="/usa-redding/lassen_ruralbus">LASSEN_RURALBUS</Link></li>
<li><Link href="/usa-redding/pacific_crest">PACIFIC_CREST</Link></li>
<li><Link href="/usa-redding/raba">RABA</Link></li>
<li><Link href="/usa-redding/sage_stage">SAGE_STAGE</Link></li>
<li><Link href="/usa-redding/trax">TRAX</Link></li>

</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-redding/amtrak">AMTRAK</Link></li>
</ul>
</div>
</div >
  <footer>
