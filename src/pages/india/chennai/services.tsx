...
<ul className = "no-bullets">
  <li><Link href="/india/chennai/bus-service/cmrl_mf_bus">CMRL MF Buses</Link></li>
  <li><Link href="/india/chennai/bus-service/ordinary_bus">MTC Ordinary Bus</Link></li>
  <li><Link href="/india/chennai/bus-service/small_bus">MTC Small Bus</Link></li>
  <li><Link href="/india/chennai/bus-service/deluxe_bus">MTC Deluxe Bus</Link></li>
  <li><Link href="/india/chennai/bus-service/express_bus">MTC Express Bus</Link></li>
  <li><Link href="/india/chennai/bus-service/ac_bus">MTC AC Bus</Link></li>

</ul>
<h1>Train agencies</h1>
<ul className = "no-bullets">
  <li><Link href="/india/chennai/train-service/suburban_rail">Chennai Suburban Rail</Link></li>
</ul>
<h1>Metro Services</h1>
<ul className = "no-bullets">
  <li><Link href="/india/chennai/train-service/metro">Chennai Metro</Link></li>
</ul>
</div>
</div >
  <footer>
