...
<li><Link href="/usa-charlotte/cats">CATS</Link></li>
<li><Link href="/usa-charlotte/ck_rider">CK_RIDER</Link></li>
</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-charlotte/amtrak">AMTRAK</Link></li>
</ul>
<h1>Light Rail Agencies</h1>
<ul className = "no-bullets">
<li><Link href="/usa-charlottesville/cat">CAT</Link></li>
</ul>
</div>
</div >
  <footer>
