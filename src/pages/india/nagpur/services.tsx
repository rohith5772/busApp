...
<ul className = "no-bullets">
  <li><Link href="/india/nagpur/bus-service/metro_feeder_bus">Nagpur Metro Feeder Bus</Link></li>
  <li><Link href="/india/nagpur/bus-service/aapli_bus_nagpur">Aapli Bus Nagpur</Link></li>
  <li><Link href="/india/nagpur/bus-service/msrtc">Msrtc (Maharashtra State Road Transport Corporation)</Link></li>
</ul>

<h1>Metro Services</h1>
<ul className = "no-bullets">
  <li><Link href="/india/nagpur/train-service/metro">Nagpur Metro</Link></li>
</ul>
</div>
</div >
  <footer>
