...
<li><Link href="/usa-atlanta/amtrak">Amtrak</Link></li>
<li><Link href="/usa-atlanta/atlantic_station">Atlantic Station</Link></li>
<li><Link href="/usa-atlanta/cats">CATS</Link></li>
<li><Link href="/usa-atlanta/cobb_linc">CobbLinc</Link></li>
<li><Link href="/usa-atlanta/connect_douglas">Connect Douglas</Link></li>
<li><Link href="/usa-atlanta/emory_shuttle">Emory Shuttle</Link></li>
<li><Link href="/usa-atlanta/gc_transit">GC Transit</Link></li>
<li><Link href="/usa-atlanta/groome_transportation">Groome Transportation</Link></li>
<li><Link href="/usa-atlanta/grta">GRTA</Link></li>
<li><Link href="/usa-atlanta/marta">MARTA</Link></li>
<li><Link href="/usa-atlanta/panther_express">Panther Express</Link></li>
<li><Link href="/usa-atlanta/rtd">RTD</Link></li>
<li><Link href="/usa-atlanta/stinger">Stinger</Link></li>
<li><Link href="/usa-atlanta/woodruff_library">Woodruff(AUC)Library Shuttle</Link></li>
<li><Link href="/usa-atlanta/street_car">Atlanta streertcar</Link></li>
</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-atlanta/train_amtrak">Amtrak</Link></li>
</ul>


<h1>Subway services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-atlanta/train_marta">MARTA</Link></li>
</ul>
