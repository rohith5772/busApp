...
<ul className = "no-bullets">
  <li><Link href="/india/pune/bus-service/pmpml">PMPML</Link></li>
  {/*<li><Link href="/india/pune/bus-service/bmtc_2">PMPML Night Bus</Link></li>*/}
</ul>
<h1>Train Services</h1>
<ul className = "no-bullets">
  <li><Link href="/india/pune/train-service/central_railways">Central Railways Pune</Link></li>
</ul>
<h1>Metro Services</h1>
<ul className = "no-bullets">
  <li><Link href="/india/pune/train-service/metro">Pune Metro</Link></li>
</ul>
</div>
</div >
  <footer>
