...
export default function App(props: any) {
  ...
  const metaDescription = "Delhi City Bus Routes TimeTable from"+props.from+"to"+ props.to;
  const titleVal = "Delhi City Bus Routes TimeTable of route " +props.busId+ " from " +props.fromVal+ " to " +props.toVal;
...
<td className = "td-class">{myArray.map((timings : any , i : number)=>{
  ...
  return (
    <div>
    <title>{titleVal}</title><meta name = "keyword" content="find bus schedule,City bus timetable, Delhi City Bus,,bus schedule,"/>
    <meta name="description" content={metaDescription} />
    <meta name="keyword" content="Delhi City Bus Routes, Delhi bus timings" />

    <h1 className="h1class"><a href="" title="Delhi Bus Routes " target="_self">Delhi City Bus Routes</a></h1>
    <div className="topnav" id="myTopnav">
    <Link id = "home" href="/india/Delhi">home</Link>
        <Link id = "bustimings"  href="/india/Delhi/bustimings">Search Bus</Link>
        <Link id = "allbuses"  href="/india/Delhi/allbuses" className="active">All Buses</Link>
        <Link id = "contact"  href="/india/Delhi/contact">Contact</Link>
        <Link id = "about"  href="/india/Delhi/about">About</Link>
        <Link id = "metrotimings" href="/india/Delhi/metrotimings">Metro Timings</Link>
...
const filePath = path.join(process.cwd(), 'src/json/india/delhi/'+filename+'.json');
