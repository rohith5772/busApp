...
<li><Link href="/usa-palmdesert/amtrak_chartered">Amtrak Charctered Vehicle</Link></li>
<li><Link href="/usa-palmdesert/mbta">MBTA</Link></li>
<li><Link href="/usa-palmdesert/pvvta">PVVTA</Link></li>
<li><Link href="/usa-palmdesert/sunline">SunLine</Link></li>
...
<ul className = "no-bullets">
<li><Link href="/usa-palmdesert/amtrak">Amtrak</Link></li>
</ul>
</div>
</div >
  <footer>
