...
<li><Link href="/usa-portlandme/gpmetro">GP Metro</Link></li>
<li><Link href="/usa-portlandme/southportlandbus">South Portland Bus</Link></li>

<li><Link href="/usa-portlandme/bsoob">BSOOB</Link></li>
</ul>

<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-portlandme/amtrak">Amtrak</Link></li>
</ul>
<h1>Ferry Agencies</h1>
<ul className = "no-bullets">
<li><Link href="/usa-portlandme/cascobaylines">Casco Bay Lines</Link></li>
</ul>
</div>
</div >
  <footer>
