...
<ul className = "no-bullets">
  <li><Link href="/usa/appleton/bus-service/valley_transit">Valley Transit</Link></li>
  <li><Link href="/usa/appleton/bus-service/go_transit">GO Transit</Link></li>
  <li><Link href="/usa/appleton/bus-service/coach_usa">Coach USA</Link></li>
  <li><Link href="/usa/appleton/bus-service/amtrak-chartered">Amtrak Chartered Vehicle</Link></li>
