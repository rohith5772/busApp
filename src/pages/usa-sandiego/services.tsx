...
<li><Link href="/usa-sandiego/airport_shuttle">Airport_Shuttle</Link></li>
<li><Link href="/usa-sandiego/amtrak_chartered">Amtrak_Chartered</Link></li>
<li><Link href="/usa-sandiego/nctd">NCTD</Link></li>
<li><Link href="/usa-sandiego/sdmts">SDMTS</Link></li>
</ul>
<h1>Train Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-sandiego/amtrak">Amtrak</Link></li>
<li><Link href="/usa-sandiego/nctd_rail">NCTD</Link></li>
</ul>
<h1>Light Rail Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-sandiego/nctd_train">NCTD</Link></li>
</ul>
<h1>Ferry Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-sandiego/sdmts_ferry">SDMTS</Link></li>

</ul>
<h1>Cable Car Services</h1>
<ul className = "no-bullets">
<li><Link href="/usa-sandiego/sdmts_cablecar">SDMTS</Link></li>
