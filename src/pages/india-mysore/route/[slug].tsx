...
export default function App(props: any) {
  ...
  const metaDescription = "Mysore City Bus Routes TimeTable from"+props.from+"to"+ props.to;
  const titleVal = "Mysore City Bus Routes TimeTable of route " +props.busId+ " from " +props.fromVal+ " to " +props.toVal;
...
<td className = "td-class">{myArray.map((timings : any , i : number)=>{
  ...
  return (
    <div>
    <title>{titleVal}</title><meta name = "keyword" content="find bus schedule,City bus timetable, Mysore City Bus,,bus schedule,"/>
    <meta name="description" content={metaDescription} />
    <meta name="keyword" content="Mysore City Bus Routes, Mysore bus timings" />

    <h1 className="h1class"><a href="" title="Mysore Bus Routes " target="_self">Mysore City Bus Routes</a></h1>
    <div className="topnav" id="myTopnav">
    <Link id = "home" href="/india/Mysore">home</Link>
        <Link id = "bustimings"  href="/india/Mysore/bustimings">Search Bus</Link>
        <Link id = "allbuses"  href="/india/Mysore/allbuses" className="active">All Buses</Link>
        <Link id = "contact"  href="/india/Mysore/contact">Contact</Link>
        <Link id = "about"  href="/india/Mysore/about">About</Link>
        <Link id = "metrotimings" href="/india/Mysore/metrotimings">Metro Timings</Link>
...
const filePath = path.join(process.cwd(), 'src/json/india/mysore/'+filename+'.json');
