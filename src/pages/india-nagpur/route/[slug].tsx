...
export default function App(props: any) {
  ...
  const metaDescription = "Nagpur City Bus Routes TimeTable from"+props.from+"to"+ props.to;
  const titleVal = "Nagpur City Bus Routes TimeTable of route " +props.busId+ " from " +props.fromVal+ " to " +props.toVal;
...
<td className = "td-class">{myArray.map((timings : any , i : number)=>{
  ...
  return (
    <div>
    <title>{titleVal}</title><meta name = "keyword" content="find bus schedule,City bus timetable, Nagpur City Bus,,bus schedule,"/>
    <meta name="description" content={metaDescription} />
    <meta name="keyword" content="Nagpur City Bus Routes, Nagpur bus timings" />

    <h1 className="h1class"><a href="" title="Nagpur Bus Routes " target="_self">Nagpur City Bus Routes</a></h1>
    <div className="topnav" id="myTopnav">
    <Link id = "home" href="/india/Nagpur">home</Link>
        <Link id = "bustimings"  href="/india/Nagpur/bustimings">Search Bus</Link>
        <Link id = "allbuses"  href="/india/Nagpur/allbuses" className="active">All Buses</Link>
        <Link id = "contact"  href="/india/Nagpur/contact">Contact</Link>
        <Link id = "about"  href="/india/Nagpur/about">About</Link>
        <Link id = "metrotimings" href="/india/Nagpur/metrotimings">Metro Timings</Link>
...
const filePath = path.join(process.cwd(), 'src/json/india/nagpur/'+filename+'.json');
