...
<ul className = "no-bullets">
  <li><Link href="/india/ahmedabad/bus-service/amts_brts">AMTS BRTS</Link></li>
  <li><Link href="/india/ahmedabad/bus-service/amts">AMTS</Link></li>
  <li><Link href="/india/ahmedabad/bus-service/vtcos_bus">VTCOS Bus</Link></li>
  <li><Link href="/india/ahmedabad/bus-service/gsrtc">GSRTC</Link></li>
</ul>

<h1>Metro Services</h1>
<ul className = "no-bullets">
  <li><Link href="/india/ahmedabad/train-service/gmrcl">GMRCL</Link></li>
</ul>
</div>
</div >
  <footer>
