...
<ul className = "no-bullets">
  <li><Link href="/india/mysore/bus-service/ksrtc_ac_bus">KSRTC AC Bus</Link></li>
  <li><Link href="/india/mysore/bus-service/ksrtc_ordinary_bus">KSRTC Ordinary Bus</Link></li>
</ul>
<h1>Train Services</h1>
<ul className = "no-bullets">
  <li><Link href="/india/mysore/train-service/swr_trains">SWR Trains</Link></li>
</ul>
