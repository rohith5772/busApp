...
<ul className = "no-bullets">
  <li><Link href="/india-ahmedabad/amts_brts">AMTS BRTS</Link></li>
  <li><Link href="/india-ahmedabad/amts">AMTS</Link></li>
  <li><Link href="/india-ahmedabad/vtcos_bus">VTCOS Bus</Link></li>
  <li><Link href="/india-ahmedabad/gsrtc">GSRTC</Link></li>

</ul>

<h1>Metro Services</h1>
<ul className = "no-bullets">
  <li><Link href="/india-ahmedabad/gmrcl">GMRCL</Link></li>
</ul>
</div>
</div >
  <footer>
